...
function SolarChange()
	...
	LockBuilding("SolarArray")
	UnlockBuilding ("SolarPanelElectronics")
	UnlockBuilding ("SolarPanelBigElectronics")
	UnlockBuilding ("SolarArrayElectronics")
	else
	UnlockBuilding("SolarPanel")
	UnlockBuilding("SolarPanelBig")
	UnlockBuilding("SolarArray")
	LockBuilding ("SolarPanelElectronics")
	LockBuilding ("SolarPanelBigElectronics")
	LockBuilding ("SolarArrayElectronics")
end
end
